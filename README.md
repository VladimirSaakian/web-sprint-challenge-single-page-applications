...
Useful for getting access to the match data without actually rendering a Route.

1. How would you explain form validation to someone who has never programmed before?

Basically makes sure that all the inputs match the data to be able to proceed

1. In 1-2 sentences, define end to end testing.
test all the product to make sure everything works together 
